...
{
    /// <summary>
    /// Manages the transition between underscores/hyphens during Json Serialize(to lower case) operations. Deserialize is case-insensitive.
    /// Serialize: Top_Left becomes top-left.
    /// Deserialize top-left becomes Top_Left (case-insensitive).
    /// <code>
    /// <![CDATA[[JsonConverter(typeof(HyphenUnderscoreLCEnumConverter<Position>))]]]>
    ...
    public class HyphenUnderscoreLCEnumConverter<T> : JsonConverter<T> where T : struct, Enum
    {
